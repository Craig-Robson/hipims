...
def send_files(broker_address: str, forecast_file: str, forecast_uuid: str):
    ...
    for file in output_files:
        # Result file name would be "uuid_0_h_runtime"
        filename = forecast_uuid + "_" + forecast_file[9:len(forecast_file) - 4] + "_" + file[file.rfind("/") + 1:len(file)]
